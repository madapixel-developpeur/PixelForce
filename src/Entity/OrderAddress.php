...
class OrderAddress
{
    ...
    public function getProvinceDepartement(): ?string
    {
        return $this->provinceDepartement;
    }

    public function setProvinceDepartement(string $provinceDepartement): self
    {
        $this->provinceDepartement = $provinceDepartement;
